<template>
  <div class="w-full h-auto min-h-screen bg-red-300 flex flex-col">
    <!-- github corner -->
    <a
      href="https://github.com/nsWilfried/"
      class="github-corner"
    ...
    <div class="w-ful p-5 bg-green-">
      <div class="w-full flex flex-col justify-center items-center bg-yellow-">
        <div class="w-full flex items-center flex-col h-auto">
          <button @click="logOut">se déconnter</button>
          <!-- add message and title card-->
          <va-card
            style="padding: 0.75rem; height: auto; position: relative"
            class="lg:w-96"
          >
            <div class="row">
              <div class="w-full flex flex-col">
                ...
                <div>
                  <textarea
                    ...
                    @focusin="showTitleInput()"
                    class="w-full h-full p-3 font-bold text-lg"
        ...
        <div
          class="w-full mt-4 h-auto flex justify-between gap-2 flex-wrap bg-violet- p-3"
        >
